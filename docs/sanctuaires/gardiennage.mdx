...
import collecteDeCoeur from "./img/collecte-de-coeur.png";
import gardienEnOr from "./img/gardien-en-or.png";
import parrainageVsGardiennage from "./img/parrainage-vs-gardiennage.png";
...
<div style={{ textAlign: 'center' }}>
  <img src={parrainageVsGardiennage} style={{maxWidth: '400px'}} alt="Gardiennage vs parrainage" />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={collecteDeCoeur} style={{maxWidth: '300px'}} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={gardienEnOr} style={{maxWidth: '300px'}} />
</div>